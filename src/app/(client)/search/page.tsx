...
export default function SearchPage() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-red-50/40 via-slate-50 to-white px-4 pb-20 pt-10 text-foreground sm:px-6 lg:px-8">
