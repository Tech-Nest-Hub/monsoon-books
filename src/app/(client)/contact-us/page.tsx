              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-red-50 rounded-lg flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-[#c10617]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-1">Email Us</h3>
                    <a href="mailto:info@monsoonbooks.com.np" className="text-slate-600 hover:text-[#c10617] transition-colors">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+97711234567" className="text-slate-600 hover:text-[#c10617] transition-colors">
                      +977 98-51000689
                    </a>
