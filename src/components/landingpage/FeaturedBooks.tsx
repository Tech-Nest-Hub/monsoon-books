      ...
      {books.length > productLimit && (
        <div className="flex justify-center pb-4 pt-8">
          <Button
            ...
            className="group relative overflow-hidden rounded-lg px-8 py-3 font-semibold text-white transition-all duration-300 disabled:opacity-50 bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700"
          >
            {isLoadingMore ? (
              <>
                <svg className="h-4 w-4 animate-spin inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                Loading...
